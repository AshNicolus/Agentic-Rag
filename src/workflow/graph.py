"""Workflow composition for Adaptive RAG.

This module composes the overall state graph which routes a question, runs
retrieval, grades retrieved documents, optionally performs web search, and
generates answers. The graph is compiled into `app` and a Mermaid PNG is
exported for a quick visualization.
"""
...
from src.workflow.const import GENERATE, GRADE_DOCUMENTS, RETRIEVE, WEBSEARCH
